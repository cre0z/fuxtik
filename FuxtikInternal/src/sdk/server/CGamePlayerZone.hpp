...
namespace source2sdk::server
{
    ...
    {
    public:
        entity2::CEntityIOOutput m_OnPlayerInZone; // 0x718        
        entity2::CEntityIOOutput m_OnPlayerOutZone; // 0x740        
        ...
        char m_PlayersInCount[0x28]; // 0x768        
        ...
        char m_PlayersOutCount[0x28]; // 0x790        
    ...
    static_assert(sizeof(CGamePlayerZone) == 0x7b8);
};
