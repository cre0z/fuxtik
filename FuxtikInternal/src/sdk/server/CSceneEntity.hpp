...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hWaitingForThisResumeScene[0x4]; // 0x568        
        ...
        char m_hRemoveActorList[0x18]; // 0x590        
        [[maybe_unused]] std::uint8_t pad_0x5a8[0x30]; // 0x5a8
        int32_t m_nSceneFlushCounter; // 0x5d8        
        // metadata: MNetworkEnable
        uint16_t m_nSceneStringIndex; // 0x5dc        
        [[maybe_unused]] std::uint8_t pad_0x5de[0x2]; // 0x5de
        entity2::CEntityIOOutput m_OnStart; // 0x5e0        
        entity2::CEntityIOOutput m_OnCompletion; // 0x608        
        entity2::CEntityIOOutput m_OnCanceled; // 0x630        
        entity2::CEntityIOOutput m_OnPaused; // 0x658        
        entity2::CEntityIOOutput m_OnResumed; // 0x680        
        entity2::CEntityIOOutput m_OnTrigger[16]; // 0x6a8        
        [[maybe_unused]] std::uint8_t pad_0x928[0x90]; // 0x928
        ...
        char m_hInterruptScene[0x4]; // 0x9b8        
        ...
        char m_hNotifySceneCompletion[0x18]; // 0x9c8        
        ...
        char m_hListManagers[0x18]; // 0x9e0        
        ...
        char m_hActivator[0x4]; // 0xa0c        
        int32_t m_BusyActor; // 0xa10        
        server::SceneOnPlayerDeath_t m_iPlayerDeathBehavior; // 0xa14        
        [[maybe_unused]] std::uint8_t pad_0xa18[0x8];
    ...
    static_assert(sizeof(CSceneEntity) == 0xa20);
};
