...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::GameTick_t m_nLastThinkTick; // 0x23c        
        ...
        [[maybe_unused]] std::uint8_t pad_0x2b9[0x7]; // 0x2b9
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        client::GameTime_t m_flCreateTime; // 0x300        
        // metadata: MNetworkEnable
        ...
        client::GameTick_t m_nNextThinkTick; // 0x334        
        ...
        server::CCollisionProperty* m_pCollision; // 0x3b8        
        // metadata: MNetworkEnable
        ...
        char m_hEffectEntity[0x4]; // 0x3c0        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        ...
        char m_hGroundEntity[0x4]; // 0x3cc        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        // metadata: MNetworkUserGroup "Player"
        ...
        [[maybe_unused]] std::uint8_t pad_0x3eb[0x1]; // 0x3eb
        int32_t m_iEFlags; // 0x3ec        
        entity2::CEntityIOOutput m_OnUser1; // 0x3f0        
        entity2::CEntityIOOutput m_OnUser2; // 0x418        
        entity2::CEntityIOOutput m_OnUser3; // 0x440        
        entity2::CEntityIOOutput m_OnUser4; // 0x468        
        int32_t m_iInitialTeamNum; // 0x490        
        // metadata: MNetworkEnable
        client::GameTime_t m_flNavIgnoreUntilTime; // 0x494        
        QAngle m_vecAngVelocity; // 0x498        
        bool m_bNetworkQuantizeOriginAndAngles; // 0x4a4        
        bool m_bLagCompensate; // 0x4a5        
        [[maybe_unused]] std::uint8_t pad_0x4a6[0x2]; // 0x4a6
    ...
    static_assert(sizeof(CBaseEntity) == 0x4c0);
};
