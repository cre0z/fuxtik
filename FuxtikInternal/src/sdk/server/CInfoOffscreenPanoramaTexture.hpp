...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_TargetEntities[0x18]; // 0x4e0        
        // metadata: MNetworkEnable
        ...
        char m_vecCSSClasses[0x18]; // 0x500        
        ...
        char m_AdditionalTargetEntities[0x18]; // 0x520        
    ...
    static_assert(sizeof(CInfoOffscreenPanoramaTexture) == 0x538);
};
