...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x4c0[0xfe0]; // 0x4c0
        ...
        char m_Entity_hLightProbeTexture[0x8]; // 0x14a0        
        // metadata: MNetworkEnable
        ...
        char m_Entity_hLightProbeDirectLightIndicesTexture[0x8]; // 0x14a8        
        // metadata: MNetworkEnable
        ...
        char m_Entity_hLightProbeDirectLightScalarsTexture[0x8]; // 0x14b0        
        // metadata: MNetworkEnable
        ...
        char m_Entity_hLightProbeDirectLightShadowsTexture[0x8]; // 0x14b8        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x1500[0x9]; // 0x1500
        // metadata: MNetworkEnable
        bool m_Entity_bEnabled; // 0x1509        
        [[maybe_unused]] std::uint8_t pad_0x150a[0x6];
    ...
    static_assert(sizeof(CEnvLightProbeVolume) == 0x1510);
};
