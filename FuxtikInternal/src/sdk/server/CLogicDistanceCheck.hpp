...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::CEntityIOOutput m_InZone1; // 0x4d8        
        entity2::CEntityIOOutput m_InZone2; // 0x500        
        entity2::CEntityIOOutput m_InZone3; // 0x528        
    ...
    static_assert(sizeof(CLogicDistanceCheck) == 0x550);
};
