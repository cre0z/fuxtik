...
namespace source2sdk::server
{
    ...
    public:
        ...
        soundsystem::soundlevel_t m_iSoundLevel; // 0x4c8        
        server::dynpitchvol_t m_dpv; // 0x4cc        
        bool m_fActive; // 0x530        
        bool m_fLooping; // 0x531        
        [[maybe_unused]] std::uint8_t pad_0x532[0x6]; // 0x532
    ...
    static_assert(sizeof(CAmbientGeneric) == 0x558);
};
