...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_PathNodes_Name[0x18]; // 0x4d0        
        ...
        char m_PathNodes_Position[0x18]; // 0x508        
        // metadata: MNetworkEnable
        ...
        char m_PathNodes_TangentIn[0x18]; // 0x520        
        // metadata: MNetworkEnable
        ...
        char m_PathNodes_TangentOut[0x18]; // 0x538        
        // metadata: MNetworkEnable
        ...
        char m_PathNodes_Color[0x18]; // 0x550        
        // metadata: MNetworkEnable
        ...
        char m_PathNodes_PinEnabled[0x18]; // 0x568        
        // metadata: MNetworkEnable
        ...
        char m_PathNodes_RadiusScale[0x18]; // 0x580        
        [[maybe_unused]] std::uint8_t pad_0x598[0x8];
    ...
    static_assert(sizeof(CPathParticleRope) == 0x5a0);
};
