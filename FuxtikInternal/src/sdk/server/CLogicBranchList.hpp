...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_LogicBranchList[0x18]; // 0x540        
        server::CLogicBranchList__LogicBranchListenerLastState_t m_eLastState; // 0x558        
        [[maybe_unused]] std::uint8_t pad_0x55c[0x4]; // 0x55c
        entity2::CEntityIOOutput m_OnAllTrue; // 0x560        
        entity2::CEntityIOOutput m_OnAllFalse; // 0x588        
        entity2::CEntityIOOutput m_OnMixed; // 0x5b0        
    ...
    static_assert(sizeof(CLogicBranchList) == 0x5d8);
};
