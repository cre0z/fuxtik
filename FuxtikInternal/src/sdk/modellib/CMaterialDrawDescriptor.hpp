...
namespace source2sdk::modellib
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x34[0x84]; // 0x34
        modellib::CRenderBufferBinding m_indexBuffer; // 0xb8        
        ...
        char m_material[0x8]; // 0xd8        
        [[maybe_unused]] std::uint8_t pad_0xe0[0x8];
    };
    #pragma pack(pop)
    ...
    static_assert(offsetof(CMaterialDrawDescriptor, m_nFirstMeshlet) == 0x18);
    static_assert(offsetof(CMaterialDrawDescriptor, m_nNumMeshlets) == 0x1c);
    ...
    static_assert(offsetof(CMaterialDrawDescriptor, m_indexBuffer) == 0xb8);
    static_assert(offsetof(CMaterialDrawDescriptor, m_material) == 0xd8);
    
    static_assert(sizeof(CMaterialDrawDescriptor) == 0xe8);
};
