...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CPerParticleFloatInput m_flOffset; // 0x1b8        
        ...
        particles::ParticleTraceSet_t m_nTraceSet; // 0x3a0        
        ...
        [[maybe_unused]] std::uint8_t pad_0x3b0[0x8]; // 0x3b0
        // metadata: MPropertyFriendlyName "No Collision Behavior"
        particles::ParticleTraceMissBehavior_t m_nTraceMissBehavior; // 0x3b8        
        ...
        [[maybe_unused]] std::uint8_t pad_0x3c2[0x2]; // 0x3c2
    ...
    static_assert(sizeof(C_OP_MovementPlaceOnGround) == 0x3d0);
};
