...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionRendererFloatInput m_nSequenceOverride; // 0x2718        
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x2870        
        ...
        [[maybe_unused]] std::uint8_t pad_0x2879[0x7]; // 0x2879
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flMinSize; // 0x2880        
        // metadata: MPropertyFriendlyName "maximum visual screen size"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flMaxSize; // 0x29d8        
        // metadata: MPropertyFriendlyName "Factor to map size adjustment to alpha"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flAlphaAdjustWithSizeAdjust; // 0x2b30        
        // metadata: MPropertyFriendlyName "screen size to start fading"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x2c88        
        // metadata: MPropertyFriendlyName "screen size to fade away"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x2de0        
        ...
        [[maybe_unused]] std::uint8_t pad_0x2f42[0x2]; // 0x2f42
        ...
        [[maybe_unused]] std::uint8_t pad_0x2f51[0x3]; // 0x2f51
        ...
        particles::ParticleLightingQuality_t m_nLightingMode; // 0x2f68        
        [[maybe_unused]] std::uint8_t pad_0x2f6c[0x4]; // 0x2f6c
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flLightingTessellation; // 0x2f70        
        // metadata: MPropertyFriendlyName "lighting directionality"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != hlx"
        particleslib::CParticleCollectionRendererFloatInput m_flLightingDirectionality; // 0x30c8        
        // metadata: MPropertyFriendlyName "Particle Shadows"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != csgo"
        bool m_bParticleShadows; // 0x3220        
        [[maybe_unused]] std::uint8_t pad_0x3221[0x3]; // 0x3221
        ...
        particles::CReplicationParameters m_replicationParameters; // 0x3228        
        [[maybe_unused]] std::uint8_t pad_0x42e8[0x8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_RenderSprites because it is not a standard-layout class
    static_assert(sizeof(C_OP_RenderSprites) == 0x42f0);
};
