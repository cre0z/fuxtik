...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionFloatInput m_flTraceLength; // 0x1d0        
        ...
        particles::ParticleTraceSet_t m_nTraceSet; // 0x3bc        
