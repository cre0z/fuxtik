...
namespace source2sdk::particles
{
    ...
    public:
        ...
        // metadata: MPropertyAttributeChoiceName "particlefield_vector"
        particles::ParticleAttributeIndex_t m_nFieldInput; // 0x1d0        
        ...
        particles::CRandomNumberGeneratorParameters m_randomnessParameters; // 0x1ec        
    ...
    static_assert(sizeof(C_INIT_AddVectorToVector) == 0x1f8);
};
