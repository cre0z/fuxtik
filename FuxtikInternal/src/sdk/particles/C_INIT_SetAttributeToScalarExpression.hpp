...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CPerParticleFloatInput m_flInput2; // 0x320        
        // metadata: MPropertyFriendlyName "output"
        particleslib::CParticleRemapFloatInput m_flOutputRemap; // 0x478        
        // metadata: MPropertyFriendlyName "output field"
        // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
        particles::ParticleAttributeIndex_t m_nOutputField; // 0x5d0        
        // metadata: MPropertyFriendlyName "set value method"
        particles::ParticleSetMethod_t m_nSetMethod; // 0x5d4        
        [[maybe_unused]] std::uint8_t pad_0x5d8[0x28];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_INIT_SetAttributeToScalarExpression because it is not a standard-layout class
    static_assert(sizeof(C_INIT_SetAttributeToScalarExpression) == 0x600);
};
