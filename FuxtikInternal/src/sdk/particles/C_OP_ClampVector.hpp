...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CPerParticleVecInput m_vecOutputMin; // 0x1c0        
        // metadata: MPropertyFriendlyName "output maximum"
        // metadata: MVectorIsSometimesCoordinate "m_nFieldOutput"
        particleslib::CPerParticleVecInput m_vecOutputMax; // 0x818        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_ClampVector because it is not a standard-layout class
    static_assert(sizeof(C_OP_ClampVector) == 0xe70);
};
