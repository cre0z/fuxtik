...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionFloatInput m_nInputMin; // 0x1c0        
        // metadata: MPropertyFriendlyName "input maximum"
        particleslib::CParticleCollectionFloatInput m_nInputMax; // 0x318        
        // metadata: MPropertyFriendlyName "output minimum"
        particleslib::CParticleCollectionFloatInput m_flOutputMin; // 0x470        
        // metadata: MPropertyFriendlyName "output maximum"
        particleslib::CParticleCollectionFloatInput m_flOutputMax; // 0x5c8        
        // metadata: MPropertyFriendlyName
        bool m_bActiveRange; // 0x720        
        [[maybe_unused]] std::uint8_t pad_0x721[0x3]; // 0x721
        // metadata: MPropertyFriendlyName "set value method"
        particles::ParticleSetMethod_t m_nSetMethod; // 0x724        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_RemapParticleCountToScalar because it is not a standard-layout class
    static_assert(sizeof(C_OP_RemapParticleCountToScalar) == 0x728);
};
