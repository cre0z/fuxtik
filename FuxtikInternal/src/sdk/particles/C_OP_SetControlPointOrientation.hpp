...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x1c1[0x1]; // 0x1c1
        ...
        particleslib::CParticleCollectionFloatInput m_flInterpolation; // 0x1e8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_SetControlPointOrientation because it is not a standard-layout class
    static_assert(sizeof(C_OP_SetControlPointOrientation) == 0x340);
};
