...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionFloatInput m_InputValue; // 0x1b8        
        ...
        particleslib::CParticleCollectionFloatInput m_Lerp; // 0x318        
    ...
    static_assert(sizeof(C_OP_SetFloatCollection) == 0x490);
};
