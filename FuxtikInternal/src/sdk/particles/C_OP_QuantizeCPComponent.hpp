...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionFloatInput m_flInputValue; // 0x1c0        
        ...
        particleslib::CParticleCollectionFloatInput m_flQuantizeValue; // 0x320        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_QuantizeCPComponent because it is not a standard-layout class
    static_assert(sizeof(C_OP_QuantizeCPComponent) == 0x478);
};
