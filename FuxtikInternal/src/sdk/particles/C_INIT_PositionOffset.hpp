...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CPerParticleVecInput m_OffsetMin; // 0x1c0        
        // metadata: MPropertyFriendlyName "offset max"
        // metadata: MVectorIsCoordinate
        particleslib::CPerParticleVecInput m_OffsetMax; // 0x818        
        // metadata: MPropertyFriendlyName "transform input"
        particleslib::CParticleTransformInput m_TransformInput; // 0xe70        
        ...
        particles::CRandomNumberGeneratorParameters m_randomnessParameters; // 0xedc        
    ...
    static_assert(sizeof(C_INIT_PositionOffset) == 0xee8);
};
