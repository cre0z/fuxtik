...
namespace source2sdk::particles
{
    ...
    public:
        ...
        char m_pTextureColorWarp[0x8]; // 0x208        
        ...
        char m_pTextureDetail2[0x8]; // 0x210        
        ...
        char m_pTextureDiffuseWarp[0x8]; // 0x218        
        ...
        char m_pTextureFresnelColorWarp[0x8]; // 0x220        
        ...
        char m_pTextureFresnelWarp[0x8]; // 0x228        
        ...
        char m_pTextureSpecularWarp[0x8]; // 0x230        
