...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particles::ParticleOrientationSetMode_t m_nOrientationMode; // 0x1cc        
        // metadata: MPropertyFriendlyName "set parent"
        particles::ParticleParentSetMode_t m_nSetParent; // 0x1d0        
    ...
    static_assert(sizeof(C_OP_SetControlPointsToParticle) == 0x1d8);
};
