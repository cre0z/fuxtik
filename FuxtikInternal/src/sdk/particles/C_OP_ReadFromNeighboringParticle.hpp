...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particles::ParticleAttributeIndex_t m_nFieldInput; // 0x1b8        
        ...
        particleslib::CPerParticleFloatInput m_DistanceCheck; // 0x1c8        
    ...
    static_assert(sizeof(C_OP_ReadFromNeighboringParticle) == 0x478);
};
