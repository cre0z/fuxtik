...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x1b9[0x3]; // 0x1b9
        // metadata: MPropertyFriendlyName "input field"
        // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
        particles::ParticleAttributeIndex_t m_nFieldInput; // 0x1bc        
    ...
    static_assert(sizeof(C_OP_RemapScalarOnceTimed) == 0x1d8);
};
