...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CPerParticleVecInput m_InputVec1; // 0x1b8        
        // metadata: MPropertyFriendlyName "input vector 2"
        particleslib::CPerParticleVecInput m_InputVec2; // 0x810        
        // metadata: MPropertyFriendlyName "output field"
        // metadata: MPropertyAttributeChoiceName "particlefield_vector"
        particles::ParticleAttributeIndex_t m_nFieldOutput; // 0xe68        
        // metadata: MPropertyFriendlyName "normalize output"
        bool m_bNormalize; // 0xe6c        
        [[maybe_unused]] std::uint8_t pad_0xe6d[0x3];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_RemapCrossProductOfTwoVectorsToVector because it is not a standard-layout class
    static_assert(sizeof(C_OP_RemapCrossProductOfTwoVectorsToVector) == 0xe70);
};
