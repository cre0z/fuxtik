...
namespace source2sdk::particles
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1c0[0x1c]; // 0x1c0
        ...
        particles::ParticleAttributeIndex_t m_nFieldOutput; // 0x1f8        
        // metadata: MPropertyFriendlyName "tint blend mode"
        particles::ParticleColorBlendMode_t m_nTintBlendMode; // 0x1fc        
    ...
    static_assert(sizeof(C_INIT_RandomColor) == 0x208);
};
