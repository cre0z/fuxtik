...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particles::ParticleAttributeIndex_t m_nAttributeToRead; // 0x1bc        
        // metadata: MPropertyFriendlyName "field to write"
        // metadata: MPropertyAttributeChoiceName "particlefield"
        particles::ParticleAttributeIndex_t m_nAttributeToWrite; // 0x1c0        
        ...
        particleslib::CParticleCollectionFloatInput m_nSnapShotStartPoint; // 0x1d0        
        // metadata: MPropertyFriendlyName "Snapshot increment amount"
        particleslib::CParticleCollectionFloatInput m_nSnapShotIncrement; // 0x328        
        // metadata: MPropertyFriendlyName "Interpolation"
        particleslib::CPerParticleFloatInput m_flInterpolation; // 0x480        
    ...
    static_assert(sizeof(C_OP_SetFromCPSnapshot) == 0x5e0);
};
