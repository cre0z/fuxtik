...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x2718        
        ...
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x2728        
        // metadata: MPropertyFriendlyName "end fade and cull screen-size"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x2880        
