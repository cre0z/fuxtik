...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CTakeDamageResult result; // 0xb0        
    ...
    static_assert(offsetof(SummaryTakeDamageInfo_t, result) == 0xb0);
    static_assert(offsetof(SummaryTakeDamageInfo_t, hTarget) == 0xc8);
    
    static_assert(sizeof(SummaryTakeDamageInfo_t) == 0xd0);
};
