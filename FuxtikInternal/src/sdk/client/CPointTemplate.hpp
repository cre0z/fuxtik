...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::CEntityIOOutput m_pOutputOnSpawned; // 0x568        
        client::PointTemplateClientOnlyEntityBehavior_t m_clientOnlyEntityBehavior; // 0x590        
        client::PointTemplateOwnerSpawnGroupType_t m_ownerSpawnGroupType; // 0x594        
        ...
        char m_createdSpawnGroupHandles[0x18]; // 0x598        
        ...
        char m_SpawnedEntityHandles[0x18]; // 0x5b0        
    ...
    static_assert(sizeof(CPointTemplate) == 0x5d8);
};
