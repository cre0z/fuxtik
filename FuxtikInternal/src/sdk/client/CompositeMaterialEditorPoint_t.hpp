...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0xf9[0x7]; // 0xf9
        // metadata: MPropertyGroupName "Preview Model"
        ...
        // CUtlVector<client::CompositeMaterialAssemblyProcedure_t> m_vecCompositeMaterialAssemblyProcedures;
        ...
        // CUtlVector<client::CompositeMaterial_t> m_vecCompositeMaterials;
        char m_vecCompositeMaterials[0x18]; // 0x1f8        
        [[maybe_unused]] std::uint8_t pad_0x210[0x8];
    };
    #pragma pack(pop)
    
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_ModelName) == 0x0);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_nSequenceIndex) == 0xe0);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_flCycle) == 0xe4);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_KVModelStateChoices) == 0xe8);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_bEnableChildModel) == 0xf8);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_ChildModelName) == 0x100);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_vecCompositeMaterialAssemblyProcedures) == 0x1e0);
    static_assert(offsetof(CompositeMaterialEditorPoint_t, m_vecCompositeMaterials) == 0x1f8);
    
    static_assert(sizeof(CompositeMaterialEditorPoint_t) == 0x218);
};
