...
namespace source2sdk::client
{
    ...
    public:
        ...
        static client::GameTick_t &Get_Zero() {return *reinterpret_cast<client::GameTick_t*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("GameTick_t")->GetStaticFields()[1]->m_pInstance);};
    };
    #pragma pack(pop)
