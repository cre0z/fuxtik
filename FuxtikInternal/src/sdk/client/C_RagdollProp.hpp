...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hRagdollSource[0x4]; // 0xf0c        
        modellib::AttachmentHandle_t m_iEyeAttachment; // 0xf10        
        [[maybe_unused]] std::uint8_t pad_0xf11[0x3]; // 0xf11
        ...
        char m_parentPhysicsBoneIndices[0x18]; // 0xf18        
