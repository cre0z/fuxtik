...
namespace source2sdk::client
{
    ...
    public:
        ...
        static client::GameTime_t &Get_Zero() {return *reinterpret_cast<client::GameTime_t*>(interfaces::g_schema->FindTypeScopeForModule("!GlobalTypes")->FindDeclaredClass("GameTime_t")->GetStaticFields()[1]->m_pInstance);};
    };
    #pragma pack(pop)
